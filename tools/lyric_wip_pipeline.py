...
from ma_lyrics_engine.export import export_bridge_payload  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    default_out = get_features_output_root() / "lyrics"
    ap.add_argument(
        "--out-dir",
        default=str(default_out),
        help=f"Output directory for JSON artifacts (default: {default_out})",
    )
