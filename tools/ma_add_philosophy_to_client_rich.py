...
def main() -> None:
    ...
    _log = di.make_logger("add_philosophy", structured=os.getenv("LOG_JSON") == "1", defaults={"tool": "add_philosophy"}, redact=settings.log_redact or LOG_REDACT, secrets=settings.log_redact_values or LOG_REDACT_VALUES)
