...
- Animations (respect reduce motion): `.maPulse(isActive:)`, `.maSlideIn(from:distance:delay:)`, `.maFloat(amplitude:duration:)`, `.maFadeIn(delay:)`, `.maShake(animatableData:travel:shakesPerUnit:)`.
